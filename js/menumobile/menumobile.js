            ...
            if(settings.type == 2){
                ...
                __this.find(".mmMenu ul.mmMain li").each(function(){
                    ...
                    if(countsize > 0){
                        ...
                        __this.find(".mmMenu .mm_mmMenu").append('<div class="m-ab" data-item="' + $(this).find("> .m-sub").data("item") + '"><div class="m-ab-arrow"><a href="javascript:">'+ a_html +'</a></div><div class="m-ab-title"></div><ul>'+ $(this).find("> ul").html()  +'</ul></div>');
                    }
                });
